	...
	return (
		<div className="w-screen h-screen relative flex items-center justify-center overflow-hidden">
			...
			<div className="mx-auto flex flex-col items-center justify-center px-5 md:px-0">
				...
				<Link
					href="https://www.e-inscricao.com/colodedeus/geracaoatmk25"
					target="_blank"
					className="bg-gradient-to-r from-[#001552] via-[#5a00e0] to-[#d35dff] rounded-full text-center py-4 md:py-6 px-10 text-xl md:text-2xl font-bold md:-translate-x-5 md:-translate-y-72 z-20"

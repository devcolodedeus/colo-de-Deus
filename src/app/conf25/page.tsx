			...
			<div className="w-screen h-screen relative flex items-center justify-center bg-[#e2e2e2] flex-col">
				...
				<div className="md:grid grid-cols-3 gap-10 z-10">
					...
					<div className="w-full h-full -translate-y-14 md:translate-y-0">
						<Link href="https://www.e-inscricao.com/colodedeus/conf25" className="w-full h-full bg-[#314fe2] flex items-center justify-center rounded-lg font-bold text-3xl md:text-4xl px-10 py-5">GARANTA SEU LUGAR</Link>
					</div>
